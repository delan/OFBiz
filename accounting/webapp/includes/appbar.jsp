	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">                      
        <tr>	       
          ...
          <td height="15" class="mainblock">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">                
              <tr>
                <td class="tabupleft"><a href="<%=response.encodeURL("/accounting/control/main" + externalKeyParam)%>" title="Accounting" class="tablinkselected"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
                <td nowrap="nowrap" class="tabupcenter"><a href="<%=response.encodeURL("/accounting/control/main" + externalKeyParam)%>" title="Accounting" class="tablinkselected">Accounting</a></td>
                <td class="tabupright"><a href="<%=response.encodeURL("/accounting/control/main" + externalKeyParam)%>" title="Accounting" class="tablinkselected"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
              </tr>               
            </table>
          </td>     
          <%}%>               
