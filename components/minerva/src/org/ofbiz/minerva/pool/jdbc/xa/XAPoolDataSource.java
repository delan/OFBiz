 ...
 * @see org.jboss.pools.ObjectPool
...
public class XAPoolDataSource
   implements DataSource, Referenceable, ObjectFactory, Serializable 
              //just including Serializable to strongly indicate serialization support
{
   ...
   public void setTransactionManager(TransactionManager tm) {factory.setTransactionManager(tm);}
   ...
   public void setTransactionIsolation(int iso) { factory.setTransactionIsolation(iso); }
   public void setTransactionIsolation(String iso) { factory.setTransactionIsolation(iso); }

   public int getPSCacheSize() {return factory.getPSCacheSize();}
   public void setPSCacheSize(int size) { factory.setPSCacheSize(size);}
   public boolean getReleaseOnCommit() {return factory.getReleaseOnCommit();}
   public void setReleaseOnCommit(boolean rel) { factory.setReleaseOnCommit(rel);}
   /**
   ...
   public void setSaveStackTrace(boolean save) { factory.setSaveStackTrace(save); }
   ...
   public void setBlockingTimeout(int blockingTimeout) {pool.setBlockingTimeout(blockingTimeout);}
