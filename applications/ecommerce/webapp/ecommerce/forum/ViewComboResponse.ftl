...
<#else>
    <#if trailList?exists>
        ...
        <a class="tabButton" href="<@ofbizUrl>/ViewBlog?contentId=${pair[0]?if_exists}&nodeTrailCsv=${csv?if_exists}"></@ofbizUrl>View</a> <br/> 
            <#assign indent = indent + "&nbsp;&nbsp;&nbsp;&nbsp;">
            <#else>
        <hr>
        <u>Add response for ${pair[0]?if_exists} - ${pair[1]?if_exists}:</u><br/>
            </#if>
