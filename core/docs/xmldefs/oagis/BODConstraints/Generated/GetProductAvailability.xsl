...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:oa="http://www.openapplications.org/oagis" version="1.0" oa:dummy-for-xmlns="">
   ...
   <axsl:template match="/">
      <schematron-output title="Schematron Validator for OAGI Constraints" schemaVersion="" phase="#ALL">
         ...
         <active-pattern name="Get ProductAvailability">
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Item" role="">
               ...
               <text>The Get ProductAvailabilitymust have an "Item" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:ItemQuantity" role="">
               ...
               <text>The Get ProductAvailability must have an "ItemQuantity" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:RequiredDateTime" role="">
               ...
               <text>The Get ProductAvailability must have a "RequiredDateTime" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Site" role="">
               ...
               <text>The Get ProductAvailability must have a "Site" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:ItemId/oa:Id" role="">
               ...
               <text>The Get ProductAvailability must have an "ItemId" and "Id" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
