      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Line" role="">
               ...
               <text>oa:Line must be present</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:DocumentDateTime" role="">
               ...
               <text>oa:DocumentDateTime must be present</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         <axsl:when test="oa:Parties/oa:SoldToParty"/>
         <axsl:otherwise>
            <failed-assert id="" test="oa:Parties/oa:SoldToParty" role="">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-get-full-path"/>
               </axsl:attribute>
               <text>oa:Parties/oa:SoldToParty must be present</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Parties/oa:SupplierParty" role="">
               ...
               <text>oa:Parties/oa:SupplierParty must be present</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
