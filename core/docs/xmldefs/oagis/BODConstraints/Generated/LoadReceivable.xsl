...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:oa="http://www.openapplications.org/oagis" version="1.0" oa:dummy-for-xmlns="">
   ...
   <axsl:template match="oa:Receivable" priority="4000" mode="M2">
      <fired-rule id="" context="oa:Receivable" role=""/>
      <axsl:choose>
   ...
   <axsl:template match="oa:Header" priority="4000" mode="M3">
      ...
      <axsl:choose>
         <axsl:when test="oa:Parties/oa:PayFromParty"/>
         <axsl:otherwise>
            <failed-assert id="" test="oa:Parties/oa:PayFromParty" role="">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-get-full-path"/>
               </axsl:attribute>
               <text>Must have a "PayFrom" Party.</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
