...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:oa="http://www.openapplications.org/oagis" version="1.0" oa:dummy-for-xmlns="">
   ...
   <axsl:template match="/">
      <schematron-output title="Schematron Validator for OAGI Constraints" schemaVersion="" phase="#ALL">
         ...
         <active-pattern name="List InventoryCount">
         ...
         <active-pattern name="Update InventoryCount Line">
            <axsl:apply-templates/>
         </active-pattern>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Header" role="">
               ...
               <text>The List InventoryCountmust have a Header component specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
   ...
   <axsl:template match="oa:InventoryCount/oa:Line" priority="4000" mode="M4">
      ...
      <axsl:choose>
         <axsl:when test="oa:Item | oa:EffectiveDateTime"/>
         <axsl:otherwise>
            <failed-assert id="" test="oa:Item | oa:EffectiveDateTime" role="">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="." mode="schematron-get-full-path"/>
               </axsl:attribute>
               <text>The InventoryCount Line must have an "Item" or an "EffectiveDateTime" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
