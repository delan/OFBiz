...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:oa="http://www.openapplications.org/oagis" version="1.0" oa:dummy-for-xmlns="">
   ...
   <axsl:template match="/">
      <schematron-output title="Schematron Validator for OAGI Constraints" schemaVersion="" phase="#ALL">
         ...
         <active-pattern name="Get Routing">
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Header" role="">
               ...
               <text>Get Routing must have a Header component specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:DocumentId/oa:Id" role="">
               ...
               <text>The Get Routing Header must have a "DocumentId" and "Id" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:DocumentId/oa:Revision" role="">
               ...
               <text>The Get Routing Header must have a "DocumentId" and "Revision" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:DocumentId/oa:Type" role="">
               ...
               <text>The Get Routing Header must have a "DocumentId" and "Type" specified</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
