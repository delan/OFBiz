...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:oa="http://www.openapplications.org/oagis" version="1.0" oa:dummy-for-xmlns="">
   ...
   <axsl:template match="/">
      <schematron-output title="Schematron Validator for OAGI Constraints" schemaVersion="" phase="#ALL">
         ...
         <active-pattern name="InventoryBalance">
            <axsl:apply-templates/>
         </active-pattern>
         <axsl:apply-templates select="/" mode="M2"/>
      </schematron-output>
   </axsl:template>
   <axsl:template match="oa:InventoryBalance" priority="4000" mode="M2">
      <fired-rule id="" context="oa:InventoryBalance" role=""/>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Item" role="">
               ...
               <text>Must have an Item component.</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:Site" role="">
               ...
               <text>Must Identify the Site of the Inventory Balance</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
      <axsl:choose>
         ...
         <axsl:otherwise>
            <failed-assert id="" test="oa:DocumentDateTime" role="">
               ...
               <text>Must have the Timestamp of the Documents creation.</text>
            </failed-assert>
         </axsl:otherwise>
      </axsl:choose>
