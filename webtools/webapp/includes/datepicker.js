...
Calendar.prototype.getMonthlyCalendarCode = function() {
  ...
  vCode = vCode + "<TABLE BORDER='1' CELLSPACING='0' CELLPADDING='0' BGCOLOR=\"" + this.gBGColor + "\">";
...
/*	this.wwrite("[<A HREF=\"javascript:window.print();\">Print</A>]</TD><TD ALIGN=center>"); */
  this.wwrite("<b>" + this.gMonthName + "<br>" + this.gYear + "</b></TD><TD ALIGN=center>");
  this.wwrite("[<A HREF=\"" +
    "javascript:window.opener.Build(" +
...
Calendar.prototype.cal_header = function() {
  ...
  vCode = vCode + "<TD WIDTH='16%' align='center'><FONT SIZE='2' FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Sat</B></FONT></TD>";
  vCode = vCode + "</TR>";
