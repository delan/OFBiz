	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">                      
        <tr>	       
          ...
          <td height="15" class="mainblock">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">                
              <tr>
                <td class="tabupleft"><a href="<%=response.encodeURL("/webtools/control/main" + externalKeyParam)%>" title="WebTools" class="tablinkselected"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
                ...
                <td class="tabupright"><a href="<%=response.encodeURL("/webtools/control/main" + externalKeyParam)%>" title="WebTools" class="tablinkselected"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
              </tr>                        
            </table>
          </td>            
