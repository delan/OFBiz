...
rm $ORION_HOME/lib/castor-0.9.3.9.jar $ORION_HOME/lib/hsqldb.jar $ORION_HOME/lib/postgresql.jar
...
rm $ORION_HOME/lib/bsh-1.2b6.jar $ORION_HOME/lib/jakarta-oro-2.0.4.jar
