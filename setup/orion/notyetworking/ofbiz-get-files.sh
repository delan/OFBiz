...
cp -i $OFBIZ_HOME/commonapp/etc/servicesengine.properties $OFBIZ_HOME/commonapp/etc/serverstats.properties $ORION_HOME/lib
...
cp -i $OFBIZ_HOME/lib/common/castor-0.9.3.9.jar $OFBIZ_HOME/lib/common/hsqldb.jar $OFBIZ_HOME/lib/common/postgresql.jar $ORION_HOME/lib
