...
cp -i $OFBIZ_HOME/commonapp/etc/entityengine.properties $OFBIZ_HOME/commonapp/etc/servicesengine.properties $OFBIZ_HOME/commonapp/etc/serverstats.properties $ORION_HOME/lib
