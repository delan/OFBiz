...
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\scripting\jruby.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\jotm\carol.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\jotm\commons-cli.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\jotm\xapool.jar
...
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\datavision\MinML2.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\datavision\jcalendar.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\datavision\gnu-regexp-1.1.4.jar
