...
if not "%OFBIZ_HOME%" == "" goto ADD_TOOLS
echo OFBIZ_HOME is not set.  Unexpected results may occur.
echo Set OFBIZ_HOME to the directory of your local ofbiz installation to avoid this message.
...
%JAVA% %JAVA_OPTS% -classpath "%JBOSS_CLASSPATH%" -Dofbiz.home="%OFBIZ_HOME%" org.jboss.Main -c ofbiz %ARGS%
