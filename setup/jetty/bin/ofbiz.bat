...
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\jotm\jonathan.jar
...
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\jotm\kilim.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\jotm\ow_util_log_file.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\jotm\ow_util_wrp_log4j.jar
...
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\wspublisher\wspublisher.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\wspublisher\EdenLib.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\wspublisher\HTTPClient.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\wspublisher\jazzy-dev.jar
set CLASSPATH=%CLASSPATH%;%OFBIZ_HOME%\lib\wspublisher\tidy.jar
