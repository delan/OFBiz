...
<%CategoryWorker.getRelatedProductCategoryMembers(pageContext,"",CatalogWorker.getCatalogPromotionsCategoryId(pageContext, CatalogWorker.getCurrentCatalogId(pageContext)),true,10);%>
