...
<TABLE width='100%' cellpadding='0' cellspacing='0' border='0' bgcolor='CCCCCC'>
  <TR>
	...
	<td bgcolor="#cccc99" onmouseover='mOvr(this,"#eeeecc");' onmouseout='mOut(this,"#cccc99");' onclick="mClk(this);" style="border-left:solid white 2px;padding-right:10px;padding-left:10px;"><a href="<%=response.encodeURL(headerControlPath + "/view/showcart")%>" class="buttontext">ViewCart</a></td>	
	<td bgcolor="#cccc99" onmouseover='mOvr(this,"#eeeecc");' onmouseout='mOut(this,"#cccc99");' onclick="mClk(this);" style="border-left:solid white 2px;padding-right:10px;padding-left:10px;"><a href="<%=response.encodeURL(headerControlPath + "/shippingAddress")%>" class="buttontext">CheckOut</a></td>
