...
%>
    <entity>
      ...
      <cmp-field>
        ...
        <column-name><%=((Field)entity.fields.elementAt(i)).columnName%></column-name>
      </cmp-field><%}%>
      ...
      </finder><%}%><%for(i=0;i<entity.finders.size();i++){%><%Finder finderDesc = (Finder)entity.finders.elementAt(i);%>
      <finder>
