...
<div class="row">
  ...
  <div class="col"><a href="<ofbiz:url>/FindFacility</ofbiz:url>" class="headerButtonLeft">Facilities</a></div>
  <div class="col"><a href="<ofbiz:url>/FindFacilityGroup</ofbiz:url>" class="headerButtonLeft">Facility&nbsp;Groups</a></div>
