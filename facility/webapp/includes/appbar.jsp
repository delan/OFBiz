	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">                      
        <tr>	       
          ...
          <td height="15" class="tabdownblock">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">                
              <tr>
                <td class="tabdownleft"><a href="<%=response.encodeURL("/catalog/control/main" + externalKeyParam)%>" title="Catalog Manager" class="tablink"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
                ...
                <td class="tabdownright"><a href="<%=response.encodeURL("/catalog/control/main" + externalKeyParam)%>" title="Catalog Manager" class="tablink"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
              </tr>
              <tr><td colspan="3" class="blackarea"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" height="1"></td></tr>
              <tr><td colspan="3" class="whitearea"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" height="1"></td></tr>                
            </table>
          ...
          <td height="15" class="mainblock">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">                
              <tr>
                <td class="tabupleft"><a href="<%=response.encodeURL("/facility/control/main" + externalKeyParam)%>" title="Facility Manager" class="tablinkselected"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
                <td nowrap="nowrap" class="tabupcenter"><a href="<%=response.encodeURL("/facility/control/main" + externalKeyParam)%>" title="Facility Manager" class="tablinkselected">Facility</a></td>
                <td class="tabupright"><a href="<%=response.encodeURL("/facility/control/main" + externalKeyParam)%>" title="Facility Manager" class="tablinkselected"><img src="<ofbiz:contenturl>/images/spacer.gif</ofbiz:contenturl>" alt="" width="24" height="15" border="0"></a></td>
              </tr>                         
            </table>
          </td>                
          <%}%>
